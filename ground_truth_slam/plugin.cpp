...
public:
    ...
    virtual void start() override
    {
        ...
        sb->schedule<imu_cam_type>(
            id, "imu_cam", [this](switchboard::ptr<const imu_cam_type> datum, std::size_t) { this->feed_ground_truth(datum); });
    }
    ...
    void feed_ground_truth(switchboard::ptr<const imu_cam_type> datum)
    {
        ...
        switchboard::ptr<pose_type> true_pose = _m_true_pose.allocate<pose_type>(
            pose_type { time_type { datum->time }, it->second.position, it->second.orientation });
