...
struct [[maybe_unused]] scene_recon_path : public switchboard::event {
    ...
    [[maybe_unused]] scene_recon_path(time_point camera_time, pose::head_pose_type pose_, std::string depth_path_, std::string rgb_path_)
        : time{camera_time}
        , pose{pose_}
...
struct [[maybe_unused]] scene_recon_type : public switchboard::event {
    ...
    [[maybe_unused]] scene_recon_type(time_point camera_time, pose::head_pose_type pose_, cv::Mat depth_, cv::Mat rgb_, bool is_last_frame)
        : time{camera_time}
        , pose{pose_}
        , depth{depth_}
        , rgb{rgb_}
