...
#include "imgui.h"
    ...
    #include <stdlib.h>                       // NULL, malloc, free, atoi
        ...
        #pragma clang diagnostic ignored \
            "-Wunused-macros" // warning : warning: macro is not used                         // we define snprintf/vsnprintf on
    ...
    if (ImGui::TreeNode("Trees")) {
        ...
        if (ImGui::TreeNode("Advanced, with Selectable nodes")) {
            ...
            static int selection_mask =
                (1 << 2); // Dumb representation of what may be user-side selection state. You may carry selection state inside
                          // or outside your objects in whatever format you see fit.
...
static void ShowDemoWindowLayout() {
    ...
    if (ImGui::TreeNode("Child windows")) {
        ...
        {
            ImGuiWindowFlags window_flags =
                (disable_mouse_wheel ? ImGuiWindowFlags_NoScrollWithMouse : 0) | (disable_menu ? 0 : ImGuiWindowFlags_MenuBar);
