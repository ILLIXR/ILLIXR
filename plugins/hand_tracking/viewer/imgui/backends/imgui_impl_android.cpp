...
//  functions e.g. ImGui::IsKeyPressed(ImGuiKey_Space). [Legacy AKEYCODE_* values will also be supported unless
//  IMGUI_DISABLE_OBSOLETE_KEYIO is set] [X] Platform: Mouse support. Can discriminate Mouse/TouchScreen/Pen.
// Missing features:
...
//  io.AddKeyModsEvent() + io.SetKeyEventNativeData() API (1.87+). Support for full ImGuiKey range. 2021-03-04: Initial version.
...
int32_t ImGui_ImplAndroid_HandleInputEvent(const AInputEvent* input_event) {
    ...
    case AINPUT_EVENT_TYPE_MOTION: {
        ...
        case AMOTION_EVENT_ACTION_UP: {
            ...
            // AMOTION_EVENT_ACTION_DOWN/_UP, but we have to process them separately to identify the actual button pressed. This
            // is done below via AMOTION_EVENT_ACTION_BUTTON_PRESS/_RELEASE. Here, we only process "FINGER" input (and
        ...
        case AMOTION_EVENT_ACTION_SCROLL:
            io.AddMouseWheelEvent(AMotionEvent_getAxisValue(input_event, AMOTION_EVENT_AXIS_HSCROLL, event_pointer_index),
