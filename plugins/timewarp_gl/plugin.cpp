...
private:
    ...
    [[nodiscard]] duration estimate_time_to_sleep(const double frame_percentage) const {
...
public:
    void _setup() {
        ...
        if (glew_err != GLEW_OK) {
            spdlog::get(name_)->error("[timewarp_gl] GLEW Error: {}", glewGetErrorString(glew_err));
