...
public:
    ...
    static void on_capture_failed(void* context, ACameraCaptureSession* session, ACaptureRequest* request,
                                  ACameraCaptureFailure* failure);

    static void on_capture_sequence_completed(void* context, ACameraCaptureSession* session, int sequenceId,
                                              int64_t frameNumber) {
        (void) context;
        (void) session;
        (void) sequenceId;
    ...
    static void on_capture_sequence_aborted(void* context, ACameraCaptureSession* session, int sequenceId) {
        (void) context;
        (void) session;
        (void) sequenceId;
    }

    static void on_capture_completed(void* context, ACameraCaptureSession* session, ACaptureRequest* request,
