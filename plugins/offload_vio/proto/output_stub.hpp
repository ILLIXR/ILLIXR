...
public:
    IMUParams()
        : params_{ILLIXR::time_point(), ILLIXR::clock_duration_{}, {}, {}, {}, {}, {}, {}} { }

    double gyro_noise() const {
        return params_.params.gyro_noise;
    }

    double acc_noise() const {
        return params_.params.acc_noise;
    }

    double gyro_walk() const {
        return params_.params.gyro_walk;
    }

    double acc_walk() const {
        return params_.params.acc_walk;
    }

    const Eigen::Matrix<double, 3, 1> n_gravity() const {
        return params_.params.n_gravity;
    }

    double imu_integration_sigma() const {
        return params_.params.imu_integration_sigma;
    }

    double nominal_rate() const {
        return params_.params.nominal_rate;
    }

    ILLIXR::data_format::imu_integrator_input params() const {
        return params_;
    }
...
public:
    ...
    int last_cam_integration_time() const {
        return 0;
    }
    ...
    const Eigen::Matrix<double, 3, 1> biasacc() const {
        return params_.params().bias_acc;
    }

    const Eigen::Matrix<double, 3, 1> biasgyro() const {
        return params_.params().bias_gyro;
    }

    const Eigen::Matrix<double, 3, 1> position() const {
        return params_.params().position;
    }

    const Eigen::Matrix<double, 3, 1> velocity() const {
        return params_.params().velocity;
    }

    const Eigen::Quaterniond rotation() const {
        return params_.params().quat;
    }
...
public:
    ...
    SlowPose slow_pose() const {
        return {};
    }

    IMUIntInput imu_int_input() const {
        return {};
    }
