...
public:
    ...
    Eigen::Vector3d angular_vel() const {
        return {};
    }

    Eigen::Vector3d linear_accel() const {
        return {};
    }
};
...
public:
    ...
    std::string img0_data() const {
        return {};
    }

    std::string img1_data() const {
        return {};
    }
...
public:
    ...
    IMUData imu_data(int) const {
        return {};
    }

    CamData cam_data() const {
        return {};
    }
};
} // namespace vio_input_proto
