...
if(NOT (libavcodec_illixr_FOUND AND libavdevice_illixr_FOUND AND
    ...
    EXTERNALPROJECT_ADD(ILLIXR_FFmpeg_ext
                        ...
                        GIT_TAG 87920541c93f3b131e3fc0a66958ef2eadef02a2
    ...
    set(libavutil_illixr_LDFLAGS -L${CMAKE_INSTALL_PREFIX}/lib;-lavutil_illixr;-pthread;-lvdpau;-lX11;-lm;-ldrm;-lvpl;-ldl;-lstdc++;-lOpenCL;-latomic;-lX11 CACHE INTERNAL "" FORCE)
    set(libavutil_illixr_LIBRARIES avutil_illixr;vdpau;X11;m;drm;vpl;dl;stdc++;OpenCL;atomic;X11 CACHE INTERNAL "" FORCE)

    set(libswscale_illixr_LDFLAGS -L${CMAKE_INSTALL_PREFIX}/lib;-lswscale_illixr;-lm;-latomic;-lavutil_illixr;-pthread;-lvdpau;-lX11;-lm;-ldrm;-lvpl;-ldl;-lstdc++;-lOpenCL;-latomic;-lX11 CACHE INTERNAL "" FORCE)
    set(libswscale_illixr_LIBRARIES swscale_illixr;m;atomic;avutil_illixr;vdpau;X11;m;drm;vpl;dl;stdc++;OpenCL;atomic;X11 CACHE INTERNAL "" FORCE)
