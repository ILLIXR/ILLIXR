...
EXTERNALPROJECT_ADD(OpenCV_Viz
        GIT_REPOSITORY https://github.com/ILLIXR/opencv.git
        GIT_TAG 7778f23491863f2ffceca1894579a53a072747e1
        PREFIX ${CMAKE_BINARY_DIR}/_deps/OpenCV_Viz
        CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${CMAKE_INSTALL_PREFIX} -DCMAKE_INSTALL_LIBDIR=${CMAKE_INSTALL_PREFIX}/lib -DCMAKE_CXX_FLAGS="-L${CMAKE_INSTALL_PREFIX}/lib" -DCMAKE_BUILD_TYPE=Release -DBUILD_TESTS=OFF -DBUILD_PERF_TESTS=OFF -DBUILD_EXAMPLES=OFF -DBUILD_JAVA=OFF -DWITH_OPENGL=ON -DWITH_VTK=ON -DOPENCV_EXTRA_MODULES_PATH="${CMAKE_BINARY_DIR}/_deps/OpenCV_Viz/src/opencv/opencv_contrib/modules"
        )
