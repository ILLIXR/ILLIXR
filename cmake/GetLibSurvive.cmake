...
if(NOT survive_FOUND)
    ...
    set(LibSurvive_DEP_STR LibSurvive_ext PARENT_SCOPE)
    set(LibSurvive_EXTERNAL Yes PARENT_SCOPE)
    ...
    set(survive_LIBRARIES "survive ${cnmatrix_LIBRARIES} ${cnkalman_LIBRARIES}" CACHE STRING INTERNAL "")
    set(survive_INCLUDE_DIRS "${CMAKE_INSTALL_PREFIX}/include/libsurvive ${CMAKE_INSTALL_PREFIX}/include/cnmatrix/libsurvive ${cnkalman_INCLUDE_DIRS} ${cnmatrix_INCLUDE_DIRS}" CACHE STRING INTERNAL "")
endif()
