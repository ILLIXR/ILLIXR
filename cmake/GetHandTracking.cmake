...
externalproject_add(
        ...
        CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${CMAKE_INSTALL_PREFIX} -DCMAKE_BUILD_TYPE=Release -DENABLE_GPU=${HT_ENABLE_GPU} -DLIBRARY_POSTFIX=ht ${DEPENDENCY_COMPILE_ARGS}
        INSTALL_COMMAND ""
)
