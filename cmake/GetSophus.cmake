...
if (NOT Sophus_FOUND)
    ...
    EXTERNALPROJECT_ADD(Sophus
            ...
            CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${CMAKE_INSTALL_PREFIX} -DCMAKE_CXX_FLAGS="-L${CMAKE_INSTALL_PREFIX}/lib" -DCMAKE_BUILD_TYPE=Release -DBUILD_SOPHUS_TESTS=OFF -DBUILD_SOPHUS_EXAMPLES=OFF -DCMAKE_INSTALL_LIBDIR=lib ${DEPENDENCY_COMPILE_ARGS}
            )
