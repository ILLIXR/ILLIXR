...
function(write_monado ver PTR)
    ...
    if(CSHELL)
        ...
        file(APPEND ${OUTFILE} "if [ ! -z \"$XDG_RUNTIME_DIR\" ]\nthen\n")
    endif()
    ...
    file(APPEND ${OUTFILE} "${SET_CMD} mpid${SPACER}`pidof monado_${ver}-service`\n")
    file(APPEND ${OUTFILE} "sleep 60\n\n")
    file(APPEND ${OUTFILE} "${OPENXR_RUNTIME}\n\n")
    file(APPEND ${OUTFILE} "kill -9 $mpid\n")
