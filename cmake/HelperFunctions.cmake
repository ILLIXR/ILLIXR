...
function(generate_yaml)
    ...
    if(NOT FORCE_REGEN AND DEFINED CACHE{LAST_YAML_BUILD} AND DEFINED CACHE{PLUGIN_LIST} AND DEFINED CACHE{VISUALIZER_LIST})
    ...
    if(FORCE_REGEN OR ($CACHE{LAST_YAML_BUILD} LESS ${PROFILE_FILE_TIMESTAMP}))
        ...
        foreach(LINE_ITEM IN LISTS YAML_LINES)
            ...
            elseif(ENTRY STREQUAL "profile")
                if(PROFILE_WRITING)
                    string(LENGTH "${USE_VIS}" VIS_LEN)
                    if(VIS_LEN GREATER 0)
