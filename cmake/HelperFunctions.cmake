...
function(generate_yaml)
    ...
    if($CACHE{LAST_YAML_BUILD} LESS ${PROFILE_FILE_TIMESTAMP})
        ...
        foreach(LINE_ITEM IN LISTS YAML_LINES)
            ...
            elseif(ENTRY STREQUAL "vulkan")
                if(NOT PROFILE_WRITING)
                    message(FATAL_ERROR "plugins/plugins.yaml has incorrect format")
                endif()
                list(GET ITEM_LIST 1 VULKAN_STR)
                file(APPEND ${OUTFILE} "vulkan: ${VULKAN_STR}\n")
...
function(read_yaml FILENAME)
    ...
    foreach(LINE IN LISTS YAML_LINES)
        ...
        elseif(KEY STREQUAL "vulkan")
            list(GET ITEM_LIST 1 VULKAN_STR)
            string(TOUPPER ${VULKAN_STR} VULKAN_UPPER)
            if(VULKAN_UPPER STREQUAL "TRUE")
                set(ILLIXR_VULKAN ON PARENT_SCOPE)
                add_compile_definitions(ILLIXR_VULKAN)
            endif()
