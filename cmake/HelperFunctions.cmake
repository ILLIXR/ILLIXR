    ...
    if($CACHE{LAST_YAML_BUILD} LESS ${PROFILE_FILE_TIMESTAMP})
        ...
        foreach(LINE_ITEM IN LISTS YAML_LINES)
            ...
            elseif(ENTRY STREQUAL "external_plugins")
                list(GET ITEM_LIST 1 EX_PLUGIN_NAMES)
                string(REPLACE "," ";" TEMP_PLUGIN_LIST ${EX_PLUGIN_NAMES})
                set(EXT_PLUGIN_LIST ${TEMP_PLUGIN_LIST} CACHE INTERNAL "" FORCE)
                file(WRITE ${ALL_FILE} "group: all\n")
                file(APPEND ${ALL_FILE} "plugins: ${PLUGIN_NAMES},${EX_PLUGIN_NAMES}\n")
        ...
        set(ILLIXR_GROUP_NAMES ${GROUP_NAMES} CACHE INTERNAL "")
    endif()
endfunction()
...
function(read_yaml FILENAME)
    ...
    foreach(LINE IN LISTS YAML_LINES)
        ...
        if(KEY STREQUAL "group" AND BUILD_GROUP STREQUAL "NONE")
            list(GET ITEM_LIST 1 GROUP_NAME)
            string(TOUPPER ${GROUP_NAME} BUILD_GROUP_UPPER)
            set(BUILD_GROUP ${BUILD_GROUP_UPPER} PARENT_SCOPE)
        elseif(KEY STREQUAL "plugins")
            list(GET ITEM_LIST 1 PLUGIN_NAMES)
            string(REPLACE "," ";" TEMP_PLUGIN_LIST ${PLUGIN_NAMES})
        ...
        elseif(KEY STREQUAL "data")
            list(GET ITEM_LIST 1 DATA_FILE_ITEM)
        ...
        elseif(KEY STREQUAL "enable_verbose_errors")
            list(GET ITEM_LIST 1 EN_VERB)
            set(ENABLE_VERBOSE_ERRORS ${EN_VERBE} PARENT_SCOPE)
...
function(check_plugins)
    ...
    foreach(PLUGIN IN LISTS EXT_PLUGIN_LIST)
        if(NOT EXISTS "${CMAKE_SOURCE_DIR}/cmake/Get${PLUGIN}.cmake")
            message(FATAL_ERROR "Cmake file for ${PLUGIN} could not be found in ${CMAKE_SOURCE_DIR}/cmake. The file should be named Get${PLUGIN}.cmake")
        endif()
    endforeach()
endfunction()
