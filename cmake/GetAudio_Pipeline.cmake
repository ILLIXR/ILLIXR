...
ExternalProject_Add(Audio_Pipeline
        ...
        GIT_TAG d7ffea367caf6c0644cc3d33cf68ce4090a2e7a5              # sha5 hash for specific commit to pull (if there is no specific tag to use)
        ...
        CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${CMAKE_INSTALL_PREFIX} -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -DILLIXR_INTEGRATION=ON -DILLIXR_ROOT=${PROJECT_SOURCE_DIR}/include -DILLIXR_BUILD_SUFFIX=${ILLIXR_BUILD_SUFFIX}
        )
