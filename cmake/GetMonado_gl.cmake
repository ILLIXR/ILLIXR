...
find_program(MONADO_GL_FOUND
             monado_gl-service
             HINTS ${CMAKE_INSTALL_PREFIX}/bin
)

find_library(MONADO_GL_OXR_LIB_FOUND
             libopenxr_monado_gl${ILLIXR_BUILD_SUFFIX}.so
...
if(MONADO_GL_FOUND AND MONADO_GL_OXR_LIB_FOUND AND MONADO_LIBRARY_FOUND)
    message(STATUS "Looking for monado_gl - found")
    set(Monado_gl_EXTERNAL NO)
else()
    ...
    EXTERNALPROJECT_ADD(MonadoGL
                        ...
                        GIT_TAG a2f144f18ec1c67981929132881443b74d05a176       # sha5 hash for specific commit to pull (if there is no specific tag to use)
                        PREFIX ${CMAKE_BINARY_DIR}/_deps/monado                # the build directory
                        DEPENDS ${OpenCV_DEP_STR} ${Vulkan_DEP_STR}            # dependencies of this module
