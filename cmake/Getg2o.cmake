...
if (NOT g2o_FOUND)
    EXTERNALPROJECT_ADD(g2o
            ...
            CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${CMAKE_INSTALL_PREFIX} -DCMAKE_CXX_FLAGS="-L${CMAKE_INSTALL_PREFIX}/lib" -DCMAKE_INSTALL_LIBDIR=lib -DCMAKE_BUILD_TYPE=Release ${DEPENDENCY_COMPILE_ARGS}
            )
