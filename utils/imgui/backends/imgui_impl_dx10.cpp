...
//  ImDrawCmd::GetTexID(). (will become a requirement) 2021-02-18: DirectX10: Change blending equation to preserve alpha in
//  output buffer. 2019-07-21: DirectX10: Backup, clear and restore Geometry Shader is any is bound when calling
...
//  automatically link with d3dcompiler.lib when using D3DCompile(). 2018-11-30: Misc: Setting up io.BackendRendererName so it
//  can be displayed in the About Window. 2018-07-13: DirectX10: Fixed unreleased resources in Init and Shutdown functions.
...
//  rectangle. 2018-04-09: Misc: Fixed erroneous call to io.Fonts->ClearInputData() + ClearTexData() that was left in DX10
//  example but removed in 1.47 (Nov 2015) on other backends. 2018-02-16: Misc: Obsoleted the io.RenderDrawListsFn callback and
//  exposed ImGui_ImplDX10_RenderDrawData() in the .h file so you can call it yourself. 2018-02-06: Misc: Removed call to
...
bool ImGui_ImplDX10_CreateDeviceObjects() {
    ...
    // d3dcompiler_XX.dll (see D3DCOMPILER_DLL_A) If you would like to use this DX10 sample code but remove this dependency you
    // can:
