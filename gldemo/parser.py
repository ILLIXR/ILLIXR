...
for obj in objects:
    print("static constexpr int " + obj["name"].capitalize() + "_NUM_TRIANGLES = " + str(len(obj["vert_indices"])) + ";")
    print("static constexpr int " + obj["name"].capitalize() + "_NUM_NORMALS = " + str(len(obj["normal_indices"])) + ";")
    print("static GLfloat " + obj["name"] + "_vertex_data = {")
    ...
    print("static GLfloat " + obj["name"] + "_normal_data = {")
