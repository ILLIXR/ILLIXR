...
public:
    ...
    virtual void start() override {
        ...
        _m_image_handle.put(_m_image_handle.allocate<image_handle>(image_handle{eyeTextures[0], 1, 0}));
        createSharedEyebuffer(&(eyeTextures[1]));
        _m_image_handle.put(_m_image_handle.allocate<image_handle>(image_handle{eyeTextures[1], 1, 1}));
