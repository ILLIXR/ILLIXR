...
public:
    ...
    public:
        ...
        event_wrapper(underlying_type underlying_data_) : underlying_data{underlying_data_} { }
...
private:
    ...
    public:
        topic(std::string name, const std::type_info& ty, std::shared_ptr<record_logger> record_logger_)
            : _m_name{name}, _m_ty{ty}, _m_record_logger{record_logger_}, _m_latest_index{0} { }
...
public:
    ...
    public:
        reader(topic& topic_) : _m_topic{topic_} {
#ifndef NDEBUG
    ...
    public:
        writer(topic& topic_) : _m_topic{topic_} { }
...
public:
     ...
     */
    switchboard(const phonebook* pb) : _m_record_logger{pb ? pb->lookup_impl<record_logger>() : nullptr} { }
