...
public:
    ...
    ~timer() { _p_duration = _p_now() - _p_start; }
...
public:
    ...
    bool operator()() { return actually_should_profile; }
 ...
 */
template <class Function, class... Args> std::thread timed_thread(const std::string& account_name, Function&& f, Args&&... args)
{
