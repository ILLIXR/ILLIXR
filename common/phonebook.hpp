...
public:
     ...
     */
    template <typename specific_service> void register_impl(std::shared_ptr<specific_service> impl)
    {
     ...
     */
    template <typename specific_service> std::shared_ptr<specific_service> lookup_impl() const
    {
