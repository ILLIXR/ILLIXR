...
#pragma once
    ...
    // In Visual Studio 2015, `constexpr` applied to a member function implies `const`, which causes ambiguous overload
    // resolution
    #if _MSC_VER <= 1900
...
namespace detail {
    ...
    struct any_compare<mat<T, M, 1>, mat<T, M, 1>> {
        ...
        constexpr ord<T> operator()(const mat<T, M, 1>& a, const mat<T, M, 1>& b) const {
    ...
    struct apply<F, scalars_t<>, vec<A, M>, vec<B, M>> {
        ...
        template<int... I>
        static constexpr type impl(seq<I...>, F f, const vec<A, M>& a, const vec<B, M>& b) {
    ...
    struct apply<F, scalars_t<C>, vec<A, M>, vec<B, M>, C> {
        ...
        template<int... I>
        static constexpr type impl(seq<I...>, F f, const vec<A, M>& a, const vec<B, M>& b, C c) {
    ...
    struct apply<F, scalars_t<B>, vec<A, M>, B, vec<C, M>> {
        ...
        template<int... I>
        static constexpr type impl(seq<I...>, F f, const vec<A, M>& a, B b, const vec<C, M>& c) {
    ...
    struct apply<F, scalars_t<A>, A, vec<B, M>, vec<C, M>> {
        ...
        template<int... I>
        static constexpr type impl(seq<I...>, F f, A a, const vec<B, M>& b, const vec<C, M>& c) {
    ...
    struct apply<F, scalars_t<>, mat<A, M, N>, mat<B, M, N>> {
        ...
        template<int... J>
        static constexpr type impl(seq<J...>, F f, const mat<A, M, N>& a, const mat<B, M, N>& b) {
    ...
    struct clamp {
        ...
        constexpr auto operator()(A a, B b, C c) const -> typename std::remove_reference<decltype(a < b       ? b
                                                                                                      : a < c ? a
                                                                                                              : c)>::type {
...
template<class A, class B>
constexpr typename detail::any_compare<A, B>::type compare(const A& a, const B& b) {
