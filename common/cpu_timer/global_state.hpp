...
namespace detail {
		...
		std::shared_ptr<Process> process;
                ...
                void create_or_lookup_process() {
                    ...
                    if (CPU_TIMER_LIKELY(infile.good())) {
                        uintptr_t intptr = 0;
                        infile >> intptr;
                        // std::cerr << "ProcessContainer::create_or_lookup_process() lookup got " << reinterpret_cast<void*>(intptr) <<
                        // " from " << filename << "\n";
                        assert(intptr);
                        ...
                        // std::cerr << "ProcessContainer::create_or_lookup_process() create put " << reinterpret_cast<void*>(intptr) <<
                        // " into " << filename << "\n";
                        outfile << intptr;
                    }
                }
	...
	public:
        ...
        static ProcessContainer process_container;
	...
	*/
	...
	private:
        ...
        static thread_local StackContainer stack_container;
