...
We have adopted the [Google style][1] for `#!Cpp class` declaration order:
...
We currently require a minimum version of 3.22 for [CMake][4]. If you use any CMake features that have changed their default behavior over time[7], we request you use CMake's `POLICY` directives to quiet any spurious warning messages. For example:
...
```
will quiet warnings about download timestamps when using [ExternalProject_Add][5] or [FetchContent_Declare][6] calls. ILLIXR also prefers the use of [ExternalProject_Add][5] over [FetchContent_Declare][6] to bring in external projects, as prefer this work to be carries out at compilation, rather than configuration, time.
...
[4]:  https://cmake.org/
[5]:  https://cmake.org/cmake/help/v3.22/module/ExternalProject.html#command:externalproject_add
[6]:  https://cmake.org/cmake/help/v3.22/module/FetchContent.html#command:fetchcontent_declare
[7]:  https://cmake.org/cmake/help/book/mastering-cmake/chapter/Policies.html#updating-a-project-for-a-new-version-of-cmake
