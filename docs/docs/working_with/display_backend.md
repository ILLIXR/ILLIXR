...
ILLIXR supports many display backends, depending on OS:
...
=== "Android"
    ...
    On Android systems the display options are more limited becuase of hardware constraints. We currenly only support the main display via EGL (OpenGL on Android)
