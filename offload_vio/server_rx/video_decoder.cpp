...
void video_decoder::create_pipelines() {
    ...
    gst_bin_add_many(GST_BIN(_pipeline_img0), _appsrc_img0, h265parse_0, identity, decoder_img0, videoconvert_0,
                     nvvideoconvert_0, caps_filter_0, _appsink_img0, nullptr);
    gst_bin_add_many(GST_BIN(_pipeline_img1), _appsrc_img1, h265parse_1, decoder_img1, videoconvert_1, nvvideoconvert_1,
                     caps_filter_1, _appsink_img1, nullptr);

    // link elements
    if (!gst_element_link_many(_appsrc_img0, decoder_img0, nvvideoconvert_0, videoconvert_0, caps_filter_0, _appsink_img0,
                               nullptr) ||
        !gst_element_link_many(_appsrc_img1, decoder_img1, nvvideoconvert_1, videoconvert_1, caps_filter_1, _appsink_img1,
                               nullptr)) {
