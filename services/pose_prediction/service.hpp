...
public:
    ...
    data_format::pose::fast_head_pose_type get_fast_pose(time_point future_timestamp) const override;
...
private:
    ...
    switchboard::reader<data_format::pose::head_pose_type>           slow_pose_;
    switchboard::reader<data_format::imu_raw_type>                   imu_raw_;
    switchboard::reader<data_format::pose::head_pose_type>           true_pose_;
