...
public:
	...
	timewarp_gl(std::string name_, phonebook* pb_)
		...
		, _m_hologram{sb->get_writer<hologram_input>("hologram_input")}
...
public:
	...
	virtual void _p_one_iteration() override {
        ...
        // Generate "starting" view matrix, from the pose sampled at the time
		...
		// Get pose for next vsync if warping, rendered pose otherwise
