...
public:
    ...
    void uncorrect_pose(const pose_type pose) const {
        ...
        //     pose_output<<timestamp<<" "<<swapped_pose.position.x()<<" "<<swapped_pose.position.y()<<"
        //     "<<swapped_pose.position.z()<<" "<< raw_o.x()<<" "<<raw_o.y()<<" "<<raw_o.z()<<" "<<raw_o.w()<<"\n";
        // }
        // pose_output.close();
    }
    ...
    virtual void _p_one_iteration() override {
        ...
        //     pose_output<< timestamp<<" "<< latest_pose.pose.position.x()<<" "<<latest_pose.pose.position.y()<<"
        //     "<<latest_pose.pose.position.z()<<" "<< latest_pose.pose.orientation.x()<<"
        //     "<<latest_pose.pose.orientation.y()<<" "<<latest_pose.pose.orientation.z()<<"
